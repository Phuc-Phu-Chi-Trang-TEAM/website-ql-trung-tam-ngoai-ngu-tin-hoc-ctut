...
class GiaoVienController extends Controller
{
    ...
    protected function layThongTinGiaoVien($id){
        $thong_tin_giao_vien = GiaoVienModel::where('Ma_giao_vien',$id)->get();
        $ds_giao_vien = GiaoVienModel::all();
        return view ('quan-ly-giao-vien',['ds_giao_vien'=>$ds_giao_vien,'thong_tin_giao_vien'=>$thong_tin_giao_vien]);
    }

    protected function chiTietGiaoVien($id){
        $chi_tiet_giao_vien = GiaoVienModel::where('Ma_giao_vien',$id)->get();
        $ds_giao_vien = GiaoVienModel::all();
